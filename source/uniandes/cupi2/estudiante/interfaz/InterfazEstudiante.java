  ...
  public void asignarNotaCurso(String pCodigo) {
    ...
    if (ingresado != null) {
      try {
        ...
        if (nota < 0) {
          JOptionPane.showMessageDialog(this, "El valor ingresado debe ser un valor positivo.", "Asignar nota",
  ...
  public void estudianteEnPrueba() {
    ...
    if (promedio == -1) {
      ...
      if (estaPrueba) {
        ...
        JOptionPane.showMessageDialog(this, "El estudiante no se encuentra en prueba académica (promedio >= 3.25).",
            "Estudiante en prueba", JOptionPane.INFORMATION_MESSAGE);
      }
    }
